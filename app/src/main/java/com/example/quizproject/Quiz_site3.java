...
public class Quiz_site3 extends AppCompatActivity {
    ...
    void btn() {
        ...
        confirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                int x = b.getInt("q2");
                if (ans_2.isChecked()) check = 1;
                check+=x;
                Toast.makeText(getApplicationContext(),"correct: "+check,Toast.LENGTH_SHORT).show();
                startActivity(new Intent(Quiz_site3.this, Quiz_site4.class).putExtra("q3", check));
            }
        });
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quiz_site3);
        calling();
        time();
        btn();
