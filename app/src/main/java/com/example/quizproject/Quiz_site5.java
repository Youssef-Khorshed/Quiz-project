...
public class Quiz_site5 extends AppCompatActivity {
    ...
    void btn() {
        ...
        confirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(Quiz_site5.this, result.class).putExtra("q5", check));
            }
        });
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quiz_site5);
        calling();
        time();
        btn();
    }
