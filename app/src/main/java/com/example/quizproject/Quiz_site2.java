...
public class Quiz_site2 extends AppCompatActivity {
    ...
    void btn() {
        ...
        confirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(Quiz_site2.this, Quiz_site3.class).putExtra("q2", check));
            }
        });
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quiz_site2);
        calling();
        time();
        btn();
